...
cameraConfig = {"exposure": 50, "gain": 1, "width": 2048, "height": 2048, "flag": True} # Configuración de la cámara
...
reference = np.ones((cameraConfig["height"], cameraConfig["width"]), dtype=np.complex128)
